...
<head>
	...
	<title>MI propio Fembed Player</title>
 ...
 */
		...
		@font-face {
			font-family: wgd;
			src: url(../fonts/wgd.woff) format("woff");
			font-weight: 400;
			font-style: normal
		}
...
<body>
	...
	//$link = decode($var);
	$link = 'https://embedsito.com/v/ryq6gue0jy65g6r';

	$sub = '';
	$tracks = '';

	$sources; // string para la fuente de link de reproduccion
	$title = '';
	$image = '';
	$referer = '';
	$status = 'fail';
...
// aqui se estrae el link raiz de una direcion
	$parsedUrl = parse_url($link);
	$root = strstr($link, $parsedUrl['path'], true);
	// $this->title = $this->title();

	$url = strtr($link, ['/v/' => '/api/source/', '/f/' => '/api/source/']);
	$ch = curl_init();
